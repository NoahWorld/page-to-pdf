...
const translations = {
  ...
  ja: {
    ...
    orientationLabel: "向き",
    marginsLabel: "余白",
    includeBgLabel: "背景を含める",
    fileNameLabel: "ファイル名",
    autoScrollLabel: "長いページのコンテンツを自動読み込み（遅延読み込みページ用）",
    exportBtn: "現在のページを PDF にエクスポート",
    exportingBtn: "エクスポート中...",
    openDownloads: "ダウンロードを開く",
    copyError: "エラーをコピー",
    tipText: "ヒント：一部のページは印刷をブロックしたり、ログインが必要な場合があります。",
    statusCapturing: "キャプチャ中",
    statusGenerating: "PDF 生成中...",
    optionMarginsDefault: "デフォルト",
    optionMarginsSmall: "小",
    optionMarginsNone: "なし",
    optionOrientationPortrait: "縦向き",
    optionOrientationLandscape: "横向き",
    optionFilenameTitle: "タイトル.pdf",
    optionFilenameDomainTitle: "ドメイン - タイトル.pdf",
    optionFilenamePrefixTitle: "カスタムプレフィックス + タイトル.pdf",
    prefixPlaceholder: "プレフィックス（例：メモ - ）",
    statusAutoScrolling: "自動スクロール中...",
    statusPrinting: "PDF 生成中...",
    statusDownloading: "ダウンロード中...",
    statusDone: "完了 ✅",
    statusFailedPrefix: "失敗：",
    failedNoTab: "失敗：アクティブなタブが見つかりません",
  ...
  ko: {
    ...
    orientationLabel: "방향",
    marginsLabel: "여백",
    includeBgLabel: "배경 포함",
    fileNameLabel: "파일 이름",
    autoScrollLabel: "긴 페이지 콘텐츠 자동 로드 (지연 로딩 페이지용)",
    exportBtn: "현재 페이지를 PDF로 내보내기",
    exportingBtn: "내보내는 중...",
    openDownloads: "다운로드 열기",
    copyError: "오류 복사",
    tipText: "팁: 일부 페이지는 인쇄를 차단하거나 로그인이 필요할 수 있습니다.",
    statusCapturing: "캡처 중",
    statusGenerating: "PDF 생성 중...",
    optionMarginsDefault: "기본값",
    optionMarginsSmall: "작게",
    optionMarginsNone: "없음",
    optionOrientationPortrait: "세로",
    optionOrientationLandscape: "가로",
    optionFilenameTitle: "제목.pdf",
    optionFilenameDomainTitle: "도메인 - 제목.pdf",
    optionFilenamePrefixTitle: "사용자 지정 접두사 + 제목.pdf",
    prefixPlaceholder: "접두사 (예: 메모 - )",
    statusAutoScrolling: "자동 스크롤 중...",
    statusPrinting: "PDF 생성 중...",
    statusDownloading: "다운로드 중...",
    statusDone: "완료 ✅",
    statusFailedPrefix: "실패:",
    failedNoTab: "실패: 활성 탭을 찾을 수 없습니다",
    errorCopied: "오류가 복사되었습니다",
    copyFailed: "복사 실패"
  },
  ar: {
    languageLabel: "اللغة",
